...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Bùi Trần Anh Khoachào ae<Color=/>"):Display()
    wait(.5)
...
W:AddLabel("Bùi Trần Anh KhoaSCRIPT")
